...
function callAndFinalize(statement, method, params) {
    try {
        method.apply(statement, params);
    } finally {
        statement.finalize();
    }
}
...
Database.prototype.run = normalizeMethod(function(statement, params) {
    callAndFinalize(statement, statement.run, params);
    return this;
});

// Database#get(sql, [bind1, bind2, ...], [callback])
Database.prototype.get = normalizeMethod(function(statement, params) {
    callAndFinalize(statement, statement.get, params);
    return this;
});

// Database#all(sql, [bind1, bind2, ...], [callback])
Database.prototype.all = normalizeMethod(function(statement, params) {
    callAndFinalize(statement, statement.all, params);
    return this;
});

// Database#each(sql, [bind1, bind2, ...], [callback], [complete])
Database.prototype.each = normalizeMethod(function(statement, params) {
    callAndFinalize(statement, statement.each, params);
    return this;
});

Database.prototype.map = normalizeMethod(function(statement, params) {
    callAndFinalize(statement, statement.map, params);
    return this;
});
